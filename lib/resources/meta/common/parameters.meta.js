...
exports.InstagramParams = exports.MetaParams = void 0;
exports.MetaParams = {
    /*
    ...
    events: {
        ...
        limit: (postLimit) => `.limit(${postLimit})`, // Limit the number of events retrieved
    ...
    isEligibleForDisableConnectIgBtnForNonPageAdminAmWeb: 'is_eligible_for_disable_connect_ig_btn_for_non_page_admin_am_web', // Check if the page is eligible to disable the connect Instagram button for non-page admins on the web
    ...
    media: {
        ...
        limit: (postLimit) => `.limit(${postLimit})`, // Limit the number of items retrieved
...
exports.InstagramParams = {
    ...
    media: {
        ...
        limit: (postLimit) => `&limit=${postLimit}`, // Limit the number of media items retrieved
