...
export class Youtube implements IYoutubeRepository {
     ...
     */
    fetchChannelSubscriptions = async (channelId:string, params:YoutubChannelSubscriptionsParams): Promise<GoogleResponse> => {
     ...
     */
    fetchChannelPlaylistItems = async (playlistId:string, params:YoutubeChannelPLaylistItemsParams): Promise<GoogleResponse> => {
     ...
     */
    fetchChannelVideosDetails = async (videoId: string, params: YoutubeChannelVideosDetailsParams): Promise<GoogleResponse> => {
